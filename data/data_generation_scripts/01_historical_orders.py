...
def generate_historical_order(order_date):
    ...
    order_status = "delivered" if order_type == "delivery" else "completed"
...
def generate_historical_orders(num_orders=8000, months_back=6):
    ...
    print(f"Total revenue: Rs {df_orders['total_amount'].sum():,.2f}")

# ============================================
# MAIN
# ============================================
if __name__ == "__main__":
    generate_historical_orders(num_orders=10000, months_back=6)